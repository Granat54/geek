public class NotebookModel { private String brand;
    ...
    public NotebookModel(String brand, String model, String color, double screenSize, String screenTechnology, int ram, int rom, String typeDisk) {
        this.brand = brand;
        this.model = model;
        this.color = color;
